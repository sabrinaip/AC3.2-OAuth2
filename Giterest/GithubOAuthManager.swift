...
//  Giterest
//
//  Created by Sabrina Ip on 11/17/16.
...
class GithubOAuthManager {
    ...
    class func configure(cliendID: String, clientSecret: String) {
        shared.clientID = cliendID
    ...
    func requestAuthorization(scopes: [GithubScope]) throws {
        ...
        let scopeQuery: URLQueryItem = URLQueryItem(name: "scope", value: scopes.flatMap { $0.rawValue }.joined(separator: " ")) // flatmap something?
